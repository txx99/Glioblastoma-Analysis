...
- First we fitted the model using lmFit() to analyze how gene expression is affected by experimental factors (psPD vs PD).

- Then, we applied contrasts with contrasts.fit() to test specific differences. 
Here we compare the average expression in psPD, MINUS the average expression in PD, aka to compare the gene expression in psPD relative to PD. 
